...
final class data_base_query{
     ...
     function db_conn($da_name){
      ...
      function update_value(){
            ...
            if($arg_num >=6 && $arg_num%2 == 0){
                    ...
                    $Q = $Q." WHERE ". $arguments[$x]." = '".$arguments[++$x]."'"; 

                   if($runquery = mysqli_query($this->link_open,$Q)){
                         if($result = mysqli_affected_rows($runquery)){               
                               mysqli_close($this->link_open);
                               return $result;
                          }
                          else{
 ...
 function d_update_value(){
            ...
            if($arg_num >=8 && $arg_num%2 == 0){
                    ...
                    $Q = $Q."  WHERE ". $arguments[$x]." = '".$arguments[++$x]."' AND ".$arguments[++$x] ." = '".$arguments[++$x]."'";
        ...
        $arguments = func_get_args();
         if($arg_num > 4){
             ...
             $x = 2;
               ...
               $Q = $Q." FROM ".$arguments[1]." WHERE ".$arguments[$x]." = '".$arguments[++$x]."'";
        ...
        $arguments = func_get_args();
         if($arg_num > 6){
              if(!data_base_query::db_conn($arguments[0])){
               ...
               $Q = $Q." FROM ".$arguments[1]." WHERE ".$arguments[$x]." = '".$arguments[++$x]."' AND ".$arguments[++$x]." ='".$arguments[++$x]."'";
